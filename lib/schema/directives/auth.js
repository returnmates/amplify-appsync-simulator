...
function protectResolversWithAuthRules(typeDef, existingResolvers, simulator) {
    var schema = (0, graphql_tools_1.buildSchemaFromTypeDefinitions)(typeDef);
    var newResolverMap = {};
    (0, graphql_tools_1.forEachField)(schema, function (field, typeName, fieldName) {
        ...
        var newResolver = function (root, args, ctx, info) {
            ...
            console.log("protectResolversWithAuthRules[" + field + "].newResolver: ", { currentAuthMode: currentAuthMode, allowedAuthTypes: allowedAuthTypes });
