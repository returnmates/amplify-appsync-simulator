...
function generateResolvers(schema, resolversConfig, simulatorContext) {
    ...
    directives.forEach(function (d) {
        directiveAST.push((0, graphql_1.parse)(d.typeDefinitions));
    });
    var documents = [schema, appSyncScalars].map(function (s) { return (0, graphql_1.parse)(s); });
    var doc = (0, graphql_1.concatAST)(__spreadArray(__spreadArray([], documents, true), directiveAST, true));
    ...
    var resolverMapWithAuth = (0, directives_1.protectResolversWithAuthRules)(doc, resolvers, simulatorContext);
