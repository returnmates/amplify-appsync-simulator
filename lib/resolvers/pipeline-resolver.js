...
var AppSyncPipelineResolver = /** @class */ (function (_super) {
    ...
    AppSyncPipelineResolver.prototype.resolve = function (source, args, context, info) {
        return __awaiter(this, void 0, void 0, function () {
            var requestMappingTemplate, responseMappingTemplate, result, stash, templateErrors, isReturn, hadException, prevResult, _i, _a, fnName, fnResolver, err_1;
            var _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        console.log({ requestMappingTemplate: requestMappingTemplate, responseMappingTemplate: responseMappingTemplate });
                        result = {};
                        stash = {};
                        ...
                        console.log({ result: result, stash: stash, errors: templateErrors, isReturn: isReturn, hadException: hadException });
                        context.appsyncErrors = __spreadArray(__spreadArray([], context.appsyncErrors, true), (templateErrors || []), true);
                        console.log({ isReturn: isReturn, hadException: hadException });
                    ...
                    case 1:
                        ...
                        console.log({ fnResolver: fnResolver });
                        _e.label = 2;
                    case 2:
                        _e.trys.push([2, 4, , 5]);
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 5];
                    case 5:
                        console.log({ result: prevResult, stash: stash, hadException: hadException });
