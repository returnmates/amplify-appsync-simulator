...
var OperationServer = /** @class */ (function () {
    function OperationServer(config, simulatorContext, subscriptionServer) {
        ...
        this.handleRequest = function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            var headers, requestAuthorizationMode, _a, _b, variables, query, operationName, doc, authorization, jwt, sourceIp, context_1, _c, gqlResult, subscriptionResult, subscription, e_1;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 6];
                    case 1: return [4 /*yield*/, (0, query_and_mutation_1.runQueryOrMutation)(this.simulatorContext.schema, doc, variables, operationName, context_1)];
                    case 2:
                        gqlResult = _d.sent();
                        return [2 /*return*/, response.send(gqlResult)];
                    case 3: return [4 /*yield*/, (0, subscriptions_1.runSubscription)(this.simulatorContext.schema, doc, variables, operationName, context_1)];
                    case 4:
                        subscriptionResult = _d.sent();
                        if (subscriptionResult.errors) {
                            return [2 /*return*/, response.send(subscriptionResult)];
                        }
                        return [4 /*yield*/, this.subscriptionServer.register(doc, variables, __assign(__assign({}, context_1), { request: request }), subscriptionResult.asyncIterator)];
                    case 5:
